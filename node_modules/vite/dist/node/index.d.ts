...
import { t as ModuleRunnerTransport } from "./chunks/moduleRunnerTransport.js.js";
...
import * as Rolldown from "rolldown.js";
...
import { parseAst as parseAst$1, parseAstAsync as parseAstAsync$1 } from "rolldown/parseAst.js";
import * as Rollup from "#types/internal/rollupTypeCompat.js";
import { esmExternalRequirePlugin } from "rolldown/plugins.js";
import { ESTree, MinifyOptions, MinifyResult, ParseResult, ParserOptions, TransformOptions as rolldown_utils_TransformOptions, TransformResult as rolldown_utils_TransformResult, Visitor, VisitorObject, minify, minifySync, parse, parseSync } from "rolldown/utils.js";
import * as http from "node:http.js";
import { Agent, ClientRequest, ClientRequestArgs, OutgoingHttpHeaders, ServerResponse } from "node:http.js";
import { Http2SecureServer } from "node:http2.js";
import * as fs from "node:fs.js";
import { EventEmitter } from "node:events.js";
import { Server as HttpsServer, ServerOptions as HttpsServerOptions } from "node:https.js";
import * as net from "node:net.js";
import { Duplex, DuplexOptions, Stream } from "node:stream.js";
import { FetchFunction, FetchFunctionOptions, FetchResult, FetchResult as moduleRunner_FetchResult, ModuleEvaluator, ModuleRunner, ModuleRunnerHmr, ModuleRunnerOptions } from "vite/module-runner.js";
...
import { SecureContextOptions } from "node:tls.js";
import { URL as url_URL } from "node:url.js";
import { ZlibOptions } from "node:zlib.js";
...
import { withFilter } from "rolldown/filter.js";
