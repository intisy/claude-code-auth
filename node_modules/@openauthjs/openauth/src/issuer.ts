 ...
 *
 * ```ts title="issuer.ts"
 * import { issuer } from "@openauthjs/openauth.js"
 *
 * const app = issuer({
 *   providers: { ... },
 *   storage,
 ...
 *
 * ```ts title="issuer.ts"
 * import { GithubProvider } from "@openauthjs/openauth/provider/github.js"
 * import { PasswordProvider } from "@openauthjs/openauth/provider/password.js"
 *
 * const app = issuer({
 *   providers: {
 ...
 * import { object, string } from "valibot.js"
 * import { createSubjects } from "@openauthjs/openauth/subject.js"
 *
 ...
 *
 * ```ts title="issuer.ts"
 * import { subjects } from "./subjects.js.js"
 *
 * const app = issuer({
 *   providers: { ... },
 *   subjects,
 ...
 *   <TabItem label="Node">
 *   ```ts title="issuer.ts"
 *   import { serve } from "@hono/node-server.js"
 *
 *   serve(app)
 *   ```
 *   </TabItem>
 ...
 *   ```ts title="issuer.ts"
 *   import { handle } from "hono/aws-lambda.js"
 *
 ...
 */
import { Provider, ProviderOptions } from "./provider/provider.js.js"
import { SubjectPayload, SubjectSchema } from "./subject.js.js"
import { Hono } from "hono/tiny.js"
import { handle as awsHandle } from "hono/aws-lambda.js"
import { Context } from "hono.js"
import { deleteCookie, getCookie, setCookie } from "hono/cookie.js"
...
import { compactDecrypt, CompactEncrypt, SignJWT } from "jose.js"
import { Storage, StorageAdapter } from "./storage/storage.js.js"
import { encryptionKeys, legacySigningKeys, signingKeys } from "./keys.js.js"
import { validatePKCE } from "./pkce.js.js"
import { Select } from "./ui/select.js.js"
import { setTheme, Theme } from "./ui/theme.js.js"
import { getRelativeUrl, isDomainMatch, lazy } from "./util.js.js"
import { DynamoStorage } from "./storage/dynamo.js.js"
import { MemoryStorage } from "./storage/memory.js.js"
...
> {
   ...
   * @example
   * ```ts title="issuer.ts"
   * import { DynamoStorage } from "@openauthjs/openauth/storage/dynamo.js"
   *
   * issuer({
   ...
   * @example
   * ```ts title="issuer.ts"
   * import { THEME_SST } from "@openauthjs/openauth/ui/theme.js"
   *
   * issuer({
   *   theme: THEME_SST
   *   // ...
   ...
   *
   * ```ts title="issuer.ts"
   * import type { Theme } from "@openauthjs/openauth/ui/theme.js"
   *
   ...
   *
   * ```ts title="issuer.ts"
   * import { Select } from "@openauthjs/openauth/ui/select.js"
   *
   * issuer({
   *   select: Select({
   *     providers: {
