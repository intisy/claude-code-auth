export declare enum ImportType {
     ...
     *   import defer * as x from 'module.js'
     */
    StaticDeferPhase = 6,
    /**
...
export interface ImportSpecifier {
     ...
     *
     * @example
     * const source = `import { a } from 'asdf.js'`;
     ...
     *
     * @example
     * const source = `import foo from 'bar.js' with { type: "json" }`;
     * const [imports] = parse(source);
     * imports[0].at;
     * // Returns [['type', 'json']]
     *
     * @example
     * const source = `import foo from 'bar.js' with { type: "json", integrity: "sha384-..." }`;
     * const [imports] = parse(source);
     * imports[0].at;
