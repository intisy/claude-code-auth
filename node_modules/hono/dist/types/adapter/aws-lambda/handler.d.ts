...
import type { Env, Schema } from '../../types.js';
import type { ALBRequestContext, ApiGatewayRequestContext, ApiGatewayRequestContextV2, Handler, LambdaContext, LatticeRequestContextV2 } from './types.js';
 ...
 * import { handle, defaultIsContentTypeBinary } from 'hono/aws-lambda.js'
 * export const handler = handle(app, {
