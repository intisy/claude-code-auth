 ...
 * @module
 */
import type { Context, MiddlewareHandler } from '../...js';
import type { AddressType, GetConnInfo } from '../../helper/conninfo.js';
/**
 ...
 * import { ipRestriction } from 'hono/ip-restriction.js'
 * import { getConnInfo } from 'hono/cloudflare-workers.js'
 *
 * const app = new Hono()
 *
 * app.use(
