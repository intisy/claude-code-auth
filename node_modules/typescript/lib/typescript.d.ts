...
declare namespace ts {
    ...
    interface ExportDeclaration extends DeclarationStatement, JSDocContainer {
        ...
        readonly modifiers?: NodeArray<ModifierLike>;
        readonly isTypeOnly: boolean;
        /** Will not be assigned in the case of `export * from "foo.js";` */
    ...
    interface Program extends ScriptReferenceHost {
         ...
         * import type {} from "mod.js" with { "resolution-mode": "import" };
    ...
    interface UserPreferences {
         ...
         * `import write|` to be completed to `import { writeFile } from "fs.js"`.
         */
